  ...
  es: {
    translations: {
      ...
      embedConfig: {
        ...
        toasts: {
          tokenGenerated: "Token de embed generado exitosamente.",
        ...
        buttons: {
          ...
          generate: "Generar Token de Embed",
          copy: "Copiar",
        },
        sections: {
          settings: "Configuración del Widget",
          token: "Token de Embed",
          iframeCode: "Código iFrame",
          iframeDescription: "Copia este código HTML y pégalo en tu página web para incrustar el panel completo.",
          widgetCode: "Widget Flotante (Script)",
          widgetDescription: "Copia este script y pégalo antes del cierre </body> para agregar un botón flotante de chat.",
          preview: "Vista Previa",
        },
        fields: {
          title: "Título del Widget",
          titleHelp: "Se muestra en la barra superior del embed.",
          welcomeMessage: "Mensaje de Bienvenida",
          welcomeMessageHelp: "Se muestra en la pantalla de login del embed.",
          allowedDomains: "Dominios Permitidos",
          allowedDomainsHelp: "Dominios separados por coma (ej: miempresa.com, otrositio.com). Dejar vacío para permitir todos.",
      ...
      shopifyConfig: {
        title: "Shopify",
        connectedStores: "Tiendas Conectadas",
        newConnection: "Nueva Conexión",
        connectNewStore: "Conectar nueva tienda Shopify",
        credentialsHelp: "Obtén tus credenciales en",
        credentialsPath: "partners.shopify.com > Apps > Tu App > Client credentials",
        noStores: "No hay tiendas conectadas. Haz clic en \"Nueva Conexión\" para comenzar.",
        form: {
          storeDomain: "Dominio de la tienda",
          storeDomainPlaceholder: "mitienda.myshopify.com",
          storeDomainHelper: "Ingresa tu dominio .myshopify.com",
          apiKey: "API Key (Client ID)",
          apiKeyPlaceholder: "ej: a1b2c3d4e5f6...",
          apiSecret: "API Secret (Client Secret)",
          apiSecretPlaceholder: "ej: shpss_...",
        },
        toasts: {
          storeConnectedSuccess: "Tienda {{shop}} conectada exitosamente",
          connectionError: "Error al conectar con Shopify. Intenta nuevamente.",
          connectionCreated: "Conexión creada. Ahora haz clic en 'Conectar' para autorizar con Shopify.",
          storeDisconnected: "Tienda desconectada",
          syncStarted: "Sincronización iniciada en segundo plano",
          credentialsUpdated: "Credenciales actualizadas",
          enterDomain: "Ingresa el dominio de tu tienda Shopify",
          enterCredentials: "Ingresa el API Key y API Secret de tu app Shopify",
          fieldsRequired: "Ambos campos son obligatorios",
        },
        table: {
          store: "Tienda",
          domain: "Dominio",
        ...
        confirmDisconnect: "¿Desconectar esta tienda Shopify?",
        products: {
          title: "Catálogo de Productos",
          searchPlaceholder: "Buscar productos...",
          noProducts: "No hay productos sincronizados. Haz clic en el botón de sync.",
          image: "Imagen",
          product: "Producto",
          type: "Tipo",
          price: "Precio",
