const messages = {
	en: {
		translations: {
			...
			webhookModal: {
				toasts: {
					update: "Webhook updated successfully!",
				},
			...
			flowBuilder: {
				...
				drawYourFlow: "Design your flow",
				rememberToSave: "Don't forget to save your flow!",
				startFlow: "Flow start",
				startFlowDesc: "This block marks the start of your flow!",
				start: "Start",
				content: "Content",
				...
				active: "Active",
				inactive: "Inactive",
				deletedSuccess: "Flow deleted successfully",
				duplicatedSuccess: "Flow duplicated successfully",
				savedSuccess: "Flow saved successfully",
				deleteConfirmMessage: "Are you sure you want to delete this flow? All related integrations will be lost.",
				duplicateConfirmTitle: "Do you want to duplicate the flow",
				duplicateConfirmMessage: "Are you sure you want to duplicate this flow?",
				seconds: "seconds",
				sec: "sec.",
				message: "Message",
				add: "Add",
				...
				addFlow: "Add Flow",
				editFlow: "Edit Flow",
				addQuestion: "Add Question to flow",
				editQuestion: "Edit flow Question",
				createQuestion: "Create Question in flow",
				saveResponse: "Save response",
				addAudio: "Add audio to flow",
				...
				addImage: "Add image to flow",
				editImage: "Edit image",
				sendImage: "Send image",
				addOpenAI: "Add OpenAI to flow",
				editOpenAI: "Edit flow OpenAI",
				createOpenAI: "Create OpenAI in flow",
				addText: "Add message to flow",
				editText: "Edit flow message",
				addTicket: "Add ticket to flow",
				editTicket: "Edit ticket",
				addTypebot: "Add Typebot to flow",
				editTypebot: "Edit flow Typebot",
				addVideo: "Add video to flow",
				editVideo: "Edit video",
				sendVideo: "Send video",
				addCondition: "Add condition to flow",
				editCondition: "Edit condition",
				conditionField: "Condition field (Enter only 1 key)",
				conditionValue: "Condition value to be analyzed",
				addInterval: "Add an interval to flow",
				editInterval: "Edit interval",
				addIntervalValue: "Add the interval value",
				maxTimeReached: "Maximum time reached 120 seconds",
				addMenu: "Add menu to flow",
				editMenu: "Edit menu",
				addOption: "Add Option",
				typeNumber: "Type {{number}}",
				typeOption: "Type option",
				addRandomizer: "Add a randomizer to flow",
				editRandomizer: "Edit randomizer",
				addContent: "Add content to flow",
				editContent: "Edit content",
				emptyMessageFields: "Empty message fields!",
				intervalCannotBeZero: "Interval cannot be 0 or greater than 120!",
				text: "Text",
				message: "Message",
				interval: "Interval",
			...
			campaignPhrase: {
				...
				editTitle: "Edit campaign with phrase flow",
				newTitle: "New campaign with phrase flow",
			...
			ultraMsgConfig: {
				...
				requiresInstanceToken: "Instance ID and Token are required",
				configSaved: "Configuration saved successfully",
				connectionSuccess: "Connection successful - Status: ",
				connectionError: "Connection error: ",
				configDeleted: "Configuration deleted",
				credentialsInfo: "To get your Instance ID and Token, register at ",
				credentialsInfoSuffix: ". After creating an instance, scan the QR code with your WhatsApp and copy the credentials here.",
				instanceIdPlaceholder: "E.g.: instance12345",
				instanceIdHelperText: "Your UltraMsg instance ID",
				tokenPlaceholder: "E.g.: abc123xyz...",
				tokenHelperText: "API authentication token",
				step1Title: "1. Configure",
				step1Description: "Enter your UltraMsg credentials and save the configuration.",
				step2Title: "2. Create Campaign",
				step2Description: "Go to the Campaigns section to create and send bulk messages.",
				step3Title: "3. Anti-Ban",
				step3Description: "Configure intervals between messages to avoid WhatsApp blocks.",
			},
			emailConfig: {
				title: "Email Configuration - Resend API",
				connectionStatus: "Connection Status",
				...
				sendTest: "Send Test",
				howItWorks: "How It Works",
				requiresApiKey: "API Key, sender email and name are required",
				configSaved: "Email configuration saved successfully",
				connectionSuccess: "Connection successful with Resend",
				connectionError: "Error: ",
				enterTestEmail: "Enter a test email",
				configDeleted: "Configuration deleted",
			...
			emailCampaigns: {
				...
				emptyState: "No email campaigns. Create a new one to get started.",
				deleteTitle: "Delete Email Campaign",
			...
			metaConnection: {
				addTitle: "Add Facebook / Instagram / Threads Connection",
				editTitle: "Edit Meta Connection",
				channel: "Channel:",
				...
				ratingMessage: "Rating message",
				queueRedirection: "Queue Redirection",
				queueRedirectionDesc: "Select a queue to redirect contacts without an assigned queue",
				...
				noMetaConnections: "No Facebook/Instagram/Threads connections. Click \"+ Facebook / Instagram / Threads\" to add one.",
				connectedSuccess: "Connected successfully",
				connectionError: "Error connecting with Meta. Please try again.",
