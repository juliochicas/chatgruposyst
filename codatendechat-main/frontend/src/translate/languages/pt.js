  ...
  pt: {
    translations: {
      ...
      checkoutPage: {
        ...
        stripeRedirect: "Pagamento com Stripe",
        stripeRedirectDesc: "Uma nova janela foi aberta com o formulário de pagamento do Stripe. Complete o pagamento lá e a fatura será atualizada automaticamente.",
      },
      companies: {
      ...
      flowBuilder: {
        ...
        addQuestion: "Adicionar Pergunta ao fluxo",
        editQuestion: "Editar Pergunta do fluxo",
        createQuestion: "Criar Pergunta no fluxo",
        saveResponse: "Salvar resposta",
        addAudio: "Adicionar áudio ao fluxo",
        editAudio: "Editar áudio",
        sendAudio: "Enviar áudio",
        sendAsRecordedAudio: "Enviar como áudio gravado na hora",
        browserNotSupportHtml5: "Seu navegador não suporta HTML5",
        addImage: "Adicionar imagem ao fluxo",
        editImage: "Editar imagem",
        sendImage: "Enviar imagem",
        addOpenAI: "Adicionar OpenAI ao fluxo",
        editOpenAI: "Editar OpenAI do fluxo",
        createOpenAI: "Criar OpenAI no fluxo",
        addText: "Adicionar mensagem ao fluxo",
        editText: "Editar mensagem do fluxo",
        addTicket: "Adicionar ticket ao fluxo",
        editTicket: "Editar ticket",
        addTypebot: "Adicionar Typebot ao fluxo",
        editTypebot: "Editar Typebot do fluxo",
        addVideo: "Adicionar vídeo ao fluxo",
        editVideo: "Editar vídeo",
        sendVideo: "Enviar vídeo",
        addCondition: "Adicionar condição ao fluxo",
        editCondition: "Editar condição",
        conditionField: "Campo da condição (Digite apenas 1 chave)",
        conditionValue: "Valor da condição a ser analisada",
        addInterval: "Adicionar um intervalo ao fluxo",
        editInterval: "Editar intervalo",
        addIntervalValue: "Adicione o valor de intervalo",
        maxTimeReached: "Máximo de tempo atingido 120 segundos",
        addMenu: "Adicionar menu ao fluxo",
        editMenu: "Editar menu",
        addOption: "Adicionar Opção",
        typeNumber: "Digite {{number}}",
        typeOption: "Digite opção",
        addRandomizer: "Adicionar um randomizador ao fluxo",
        editRandomizer: "Editar randomizador",
        addContent: "Adicionar conteúdo ao fluxo",
        editContent: "Editar conteúdo",
        emptyMessageFields: "Campos de mensagem vazios!",
        intervalCannotBeZero: "Intervalo não pode ser 0 ou maior que 120!",
        text: "Texto",
        message: "Mensagem",
        interval: "Intervalo",
        ...
        options: "Opções",
        toasts: {
          audioSuccess: "Audio adicionado com sucesso!",
          imageSuccess: "Imagem adicionada com sucesso!",
          videoSuccess: "Video adicionado com sucesso!",
          fileTooLarge: "Arquivo é muito grande!",
          selectQueue: "Adicione uma fila",
        },
      },
      contactNotes: {
