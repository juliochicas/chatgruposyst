  ...
  pt: {
    translations: {
      ...
      kanban: {
        ...
        empty: {
          title: "Kanban vazio",
          description: "Não há tickets nem tags kanban configuradas. Crie tags com a opção Kanban ativada em Tags para começar.",
        },
      },
      invoices: {
        title: "Faturas",
      ...
      flowBuilder: {
        ...
        drawYourFlow: "Desenhe seu fluxo",
        rememberToSave: "Não se esqueça de salvar seu fluxo!",
        startFlow: "Início do fluxo",
        startFlowDesc: "Este bloco marca o início do seu fluxo!",
        start: "Início",
        content: "Conteúdo",
        ...
        active: "Ativo",
        inactive: "Desativado",
        deletedSuccess: "Fluxo excluído com sucesso",
        duplicatedSuccess: "Fluxo duplicado com sucesso",
        savedSuccess: "Fluxo salvo com sucesso",
        deleteConfirmMessage: "Tem certeza que deseja deletar este fluxo? Todas as integrações relacionados serão perdidos.",
        duplicateConfirmTitle: "Deseja duplicar o fluxo",
        duplicateConfirmMessage: "Tem certeza que deseja duplicar este fluxo?",
        seconds: "segundos",
        sec: "seg.",
        message: "Mensagem",
        add: "Adicionar",
      ...
      ultraMsgConfig: {
        ...
        requiresInstanceToken: "Instance ID e Token são obrigatórios",
        configSaved: "Configuração salva com sucesso",
        connectionSuccess: "Conexão realizada com sucesso - Status: ",
        connectionError: "Erro de conexão: ",
        configDeleted: "Configuração excluída",
        credentialsInfo: "Para obter seu Instance ID e Token, registre-se em ",
        credentialsInfoSuffix: ". Após criar uma instância, escaneie o código QR com seu WhatsApp e copie as credenciais aqui.",
        instanceIdPlaceholder: "Ex: instance12345",
        instanceIdHelperText: "ID da sua instância no UltraMsg",
        tokenPlaceholder: "Ex: abc123xyz...",
        tokenHelperText: "Token de autenticação da API",
        step1Title: "1. Configurar",
        step1Description: "Insira suas credenciais do UltraMsg e salve a configuração.",
        step2Title: "2. Criar Campanha",
        step2Description: "Vá à seção de Campanhas para criar e enviar mensagens em massa.",
        step3Title: "3. Anti-Ban",
        step3Description: "Configure intervalos entre mensagens para evitar bloqueios do WhatsApp.",
      },
      emailConfig: {
        title: "Configuração Email - Resend API",
        connectionStatus: "Status da Conexão",
        resendCredentials: "Credenciais do Resend",
        apiKey: "API Key",
        ...
        update: "Atualizar",
        testConnection: "Testar Conexão",
        deleteConfig: "Excluir",
        sendTestEmail: "Enviar Email de Teste",
        testEmailPlaceholder: "Email de teste",
        sendTest: "Enviar Teste",
        howItWorks: "Como Funciona",
        requiresApiKey: "API Key, email remetente e nome são obrigatórios",
        configSaved: "Configuração de email salva com sucesso",
        connectionSuccess: "Conexão realizada com sucesso com o Resend",
        connectionError: "Erro: ",
        enterTestEmail: "Insira um email de teste",
        configDeleted: "Configuração excluída",
      ...
      emailCampaigns: {
        ...
        emptyState: "Não há campanhas de email. Crie uma nova para começar.",
        deleteTitle: "Excluir Campanha de Email",
        deleteConfirm: "Tem certeza que deseja excluir esta campanha?",
        reportTitle: "Relatório da Campanha: ",
        total: "Total",
        sent: "Enviados",
        failed: "Falhas",
        pending: "Pendentes",
      ...
      metaConnection: {
        addTitle: "Adicionar Conexão Facebook / Instagram / Threads",
        editTitle: "Editar Conexão Meta",
        channel: "Canal:",
        ...
        ratingMessage: "Mensagem de avaliação",
        queueRedirection: "Redirecionamento de Fila",
        queueRedirectionDesc: "Selecione uma fila para redirecionar contatos sem fila atribuída",
        ...
        connectWithMeta: "Conectar com Meta",
        addMeta: "+ Facebook / Instagram / Threads",
        metaSectionTitle: "Facebook / Instagram / Threads",
        noMetaConnections: "Não há conexões de Facebook/Instagram/Threads. Clique em \"+ Facebook / Instagram / Threads\" para adicionar uma.",
        connectedSuccess: "Conectado com sucesso",
        connectionError: "Erro ao conectar com Meta. Tente novamente.",
        whatsappSection: "WhatsApp",
        channelHeader: "Canal",
        nameHeader: "Nome",
        statusHeader: "Status",
        sessionHeader: "Sessão",
        lastUpdateHeader: "Última atualização",
        accountHeader: "Conta",
        actionsHeader: "Ações",
      },
      backendErrors: {
