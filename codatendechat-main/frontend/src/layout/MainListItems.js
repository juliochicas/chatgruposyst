...
import { AccountTree, AllInclusive, AttachFile, BlurCircular, Chat, DeviceHubOutlined, Public, Schedule } from '@material-ui/icons';
        ...
        yes={() => (
          <>
            ...
            {showIntegrations && (
              <ListItemLink
                to="/channels"
                primary={i18n.t("mainDrawer.listItems.channels")}
                icon={<Public />}
              />
            )}
            <ListItemLink
